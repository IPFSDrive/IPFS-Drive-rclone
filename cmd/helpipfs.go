...
//
//See the home page (https://ipfsdrive.org/) for installation, usage,
...
//			fmt.Printf("%s\n\n", opt.Help)
//			if opt.IsPassword {
//				fmt.Printf("**NB** Input to this must be obscured - see [ipfsdrive obscure](/commands/ipfsdrive_obscure/).\n\n")
//			}
//			fmt.Printf("- Config:      %s\n", opt.Name)
